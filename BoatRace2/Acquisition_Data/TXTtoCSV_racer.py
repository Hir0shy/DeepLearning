...
file_list = os.listdir('racer_txt/')
# 変数初期化
m = ""
f = ""
line = ""
...
for m in file_list :
	if (i == 0):
		filename = "boat-racer.csv"
		f2 = open("racer_csv/" + filename ,"w")
		f2.write(head)
	# 拡張子がtxtならば実行
	if re.search(r".txt",m) or re.search(r".TXT",m):
		f = open("racer_txt/" + m,"r")
		# ファイルの中身を一行ずつ
		for n in f :			
			for l in bytes :
				out = n[l[0]:l[1]] 
