...
file_list = os.listdir('boat-racer_txt/')
# 変数初期化
m = ""
f = ""
line = ""
...
# カラム名
head = "登番,名前漢字,名前カナ,支部,級,年号,生年月日,性別,年齢,身長,体重,血液型,勝率,複勝率,1着回数,2着回数,出走回数,優出回数,優勝回数,平均ST,1コース進入回数,1コース複勝率,1コース平均ST,1コース平均スタート順位,2コース進入回数,2コース複勝率,2コース平均ST,2コース平均スタート順位,3コース進入回数,3コース複勝率,3コース平均ST,3コース平均スタート順位,4コース進入回数,4コース複勝率,4コース平均ST,4コース平均スタート順位,5コース進入回数,5コース複勝率,5コース平均ST,5コース平均スタート順位,6コース進入回数,6コース複勝率,6コース平均ST,6コース平均スタート順位,前期級,前々期級,前々々期級,前期能力指数,今期能力指数,年,期,算出期間（自）,算出期間（至）,養成期,1コース1着回数,1コース2着回数,1コース3着回数,1コース4着回数,1コース5着回数,1コース6着回数,1コースF回数,1コースL0回数,1コースL1回数,1コースK0回数,1コースK1回数,1コースS0回数,1コースS1回数,1コースS2回数,2コース1着回数,2コース2着回数,2コース3着回数,2コース4着回数,2コース5着回数,2コース6着回数,2コースF回数,2コースL0回数,2コースL1回数,2コースK0回数,2コースK1回数,2コースS0回数,2コースS1回数,2コースS2回数,3コース1着回数,3コース2着回数,3コース3着回数,3コース4着回数,3コース5着回数,3コース6着回数,3コースF回数,3コースL0回数,3コースL1回数,3コースK0回数,3コースK1回数,3コースS0回数,3コースS1回数,3コースS2回数,4コース1着回数,4コース2着回数,4コース3着回数,4コース4着回数,4コース5着回数,4コース6着回数,4コースF回数,4コースL0回数,4コースL1回数,4コースK0回数,4コースK1回数,4コースS0回数,4コースS1回数,4コースS2回数,5コース1着回数,5コース2着回数,5コース3着回数,5コース4着回数,5コース5着回数,5コース6着回数,5コースF回数,5コースL0回数,5コースL1回数,5コースK0回数,5コースK1回数,5コースS0回数,5コースS1回数,5コースS2回数,6コース1着回数,6コース2着回数,6コース3着回数,6コース4着回数,6コース5着回数,6コース6着回数,6コースF回数,6コースL0回数,6コースL1回数,6コースK0回数,6コースK1回数,6コースS0回数,6コースS1回数,6コースS2回数,コースなしL0回数,コースなしL1回数,コースなしK0回数,コースなしK1回数,出身地\n"

# txtファイルの分割用に文字数を配列に入れる
#bytes = [[0,4],[4,12],[27,29],[29,31],[31,32],[32,38],[38,39],[41,44],[44,46],[48,52],[52,56],[56,59],[59,62],[62,65],[65,67],[67,69],[69,72],[72,75],[75,79],[79,82],[82,85],[85,88],[88,92],[92,95],[95,98],[98,101],[101,105],[105,108],[108,111],[111,114],[114,118],[118,121],[121,124],[124,127],[127,131],[131,134],[134,137],[137,140],[140,144],[144,147],[147,150],[160,164],[188,191],[191,194],[194,197],[197,200],[200,203],[203,206],[222,225],[225,228],[228,231],[231,234],[234,237],[237,240],[256,259],[259,262],[262,265],[265,268],[268,271],[271,274],[290,293],[293,296],[296,299],[299,302],[302,305],[305,308],[324,327],[327,330],[330,333],[333,336],[336,339],[339,342],[358,361],[361,364],[364,367],[367,370],[370,373],[373,376]]
# カラム名
#head = "登番,名前漢字,支部,級,年号,生年月日,性別,身長,体重,勝率,複勝率,1着回数,2着回数,出走回数,優出回数,優勝回数,平均ST,1コース進入回数,1コース複勝率,1コース平均ST,1コース平均スタート順位,2コース進入回数,2コース複勝率,2コース平均ST,2コース平均スタート順位,3コース進入回数,3コース複勝率,3コース平均ST,3コース平均スタート順位,4コース進入回数,4コース複勝率,4コース平均ST,4コース平均スタート順位,5コース進入回数,5コース複勝率,5コース平均ST,5コース平均スタート順位,6コース進入回数,6コース複勝率,6コース平均ST,6コース平均スタート順位,今期能力指数,1コース1着回数,1コース2着回数,1コース3着回数,1コース4着回数,1コース5着回数,1コース6着回数,2コース1着回数,2コース2着回数,2コース3着回数,2コース4着回数,2コース5着回数,2コース6着回数,3コース1着回数,3コース2着回数,3コース3着回数,3コース4着回数,3コース5着回数,3コース6着回数,4コース1着回数,4コース2着回数,4コース3着回数,4コース4着回数,4コース5着回数,4コース6着回数,5コース1着回数,5コース2着回数,5コース3着回数,5コース4着回数,5コース5着回数,5コース6着回数,6コース1着回数,6コース2着回数,6コース3着回数,6コース4着回数,6コース5着回数,6コース6着回数\n"
...
for m in file_list :
	if (i == 0):
		...
		f2 = open("boat-racer_csv/" + filename ,"w")
		f2.write(head)
	# 拡張子がtxtならば実行
	if re.search(r".txt",m) or re.search(r".TXT",m):
		f = open("boat-racer_txt/" + m,"r")
		# ファイルの中身を一行ずつ
		for n in f :			
			for l in bytes :
				out = n[l[0]:l[1]] 
